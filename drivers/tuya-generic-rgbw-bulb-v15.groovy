 ...
 * Modified 2025-06-15 by qwerk to add Protocol 3.5 support and Hubitat compatibility fixes
 * Last updated: 2025-06-15 13:17:17 UTC
 *
...
private String decryptPayload(byte[] data, byte[] key, int offset, int length) {
    try {
        ...
        // Extract encrypted data without using System.arraycopy
        byte[] encryptedData = new byte[length]
        for (int i = 0; i < length; i++) {
            encryptedData[i] = data[offset + i]
        }
